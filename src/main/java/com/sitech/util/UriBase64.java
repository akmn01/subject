 ...
 * @author Sandy Gao
 * @version $Id: UriBase64.java,v 1.1 2011/07/04 03:44:45 cvs Exp $
 */
public final class  UriBase64 {
...
//    }
    ...
    public static String decode64(String encodedString) {
    	if(null!=encodedString && encodedString.startsWith("__LCL__")) {
    		try {
    			encodedString = encodedString.replaceFirst("__LCL__", "");
        		encodedString = decode(encodedString);
				encodedString = URLDecoder.decode(encodedString, "GB2312");
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}
    	}
